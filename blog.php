...
<!-- Mirrored from themesflat.co/html/restaurant/coffee/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 May 2026 10:07:00 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
        ...
        <div id="page" class="">
            ...
            <div class="banner-page">
                ...
                <div class="themesflat-container">
                    <div class="row">
                        <div class="col-12">
                            <div class="text">- What's New In Our Blog? -</div>
            ...
            <!-- wg-update -->
                <!-- <div class="wg-update">
                    <div class="themesflat-container">
                        <div class="row">
                            <div class="col-12">
                                <div class="wg-update-wrap">
                                    <img class="item-1" src="assets/images/item-background/item-7.png" alt="">
                                    <img class="item-2" src="assets/images/item-background/item-8.png" alt="">
                                    <div class="title">Sign up to receive Latest news from us</div>
                                    <div class="text">we will send you offers about discounts or gifts, you just need to enter your email to follow the offer, thank<br>you for using basilico coffee products, we look forward to you every day</div>
                                    <form class="comment-form">
                                        <fieldset class="email">
                                            <input type="email" placeholder="Email address..." class="" name="email" tabindex="2" value="" aria-required="true" required="">
                                        </fieldset>
                                        <div class="">
                                            <button class="" type="submit"><i class="icon-send"></i></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="wg-blog wow fadeInUp">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="title"><a href="#">What determines the color of the coffee extract?</a></div>
                                        ...
                                        <div class="bottom">
                                            <a class="button-default" href="#">Read more <i class="icon-arrow-right2"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
