...
<!-- Mirrored from themesflat.co/html/restaurant/coffee/reservation.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 May 2026 10:06:40 GMT -->
<head>
    <!-- Basic Page Needs -->
    <meta charset="utf-8">
...
<body class="body">
    ...
    <div id="wrapper">
        ...
        <div id="page" class="">
            ...
            <!-- banner-page -->
            <div class="banner-page reservation-page">
    <div class="themesflat-container">
        <div class="row">
            <div class="col-12">
                <div class="text">- Fresh Moments From Sehat Veda -</div>
        ...
        <div class="container">
            ...
            <div class="text-center mb-5">
                ...
                <p class="text-muted">
                    Explore our healthy meals, fresh ingredients, and delicious creations.
                </p>
            </div>
