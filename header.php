<header id="header_main" class="header header-fixed style-absolute">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="header-top">
                                ...
                                <div class="wg-information call row-reverse text-end">
                                    <div class="icon">
                                    ...
                                    <div class="content">
                                        <div class="title">CALL DELIVERY</div>
                                        <p>+91 9899591067</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="header-inner"> 
                    <div class="header-inner-wrap">
                        ...
                        <div id="site-logo">
                            <div id="site-logo-inner">
                                <a href="index.php" rel="home" class="main-logo">
                                    <img id="logo_header" alt="" src="assets/images/logo/logo2.png"
                                    data-retina="assets/images/logo/main_logo.png" style="width: auto; height: auto;">
                                </a>
                            </div>
                        </div><!-- /logo -->
                        <nav class="main-nav right">
                            <ul class="menu-primary-menu">
                               <li class="menu-item">
                                    <a class="item-menu-mobile" href="gallery.php">Gallery</a>
                                </li>
                ...
                <div class="mobile-nav-wrap">
                    ...
                    <div class="inner-mobile-nav">
                        <a href="index.php" rel="home" class="main-logo">
                            <img id="mobile-logo_header" alt="" src="assets/images/logo/logo2.png" data-retina="assets/images/logo/logo2.png">
                        </a>
                        ...
                        <nav id="mobile-main-nav" class="mobile-main-nav">
                            <ul id="menu-mobile-menu" class="menu">
                                ...
                                <li class="menu-item">
                                    <a class="item-menu-mobile" href="about.php">About Us</a>
                                </li>
                                <li class="menu-item">
                                    <a class="item-menu-mobile" href="menu.php">Menu</a>
                                </li>
                                <li class="menu-item">
                                    <a class="item-menu-mobile" href="gallery.php">Gallery</a>
                                </li>
                                <li class="menu-item menu-item-has-children-mobile">
                                    <a class="item-menu-mobile" href="blog.php">Blog</a>
                                </li>
                                <li class="menu-item">
                                    <a href="contact.php">Contact</a>
                                </li>
